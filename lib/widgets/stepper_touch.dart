  ...
  Widget build(BuildContext context) {
    return FittedBox(
      child: Container(
        ...
        height: widget.direction == Axis.horizontal ? 120.0 : 350.0,
        child: Material(
          ...
          child: Stack(
            ...
            children: <Widget>[
              Positioned(
                ...
                children: <Widget>[
                  Icon(Icons.mic_none, size: 40.0, color: widget.buttonsColor),
              ...
              Positioned(
                ...
                child: Column(
                  mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                  children: <Widget>[
                    Icon(Icons.translate, size: 40.0, color: widget.buttonsColor),
                  ...
                  child: Material(
                    ...
                    child: Center(
                      child: AnimatedSwitcher(
                        ...
                        child: Icon(Icons.mic_sharp, size: 70.0, color: Colors.black),
                      ),
                    ),
                  ),
                ),
